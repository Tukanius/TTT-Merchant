...
class WalletQpayChargeArguments {
  final QpayPayment data;

  WalletQpayChargeArguments({required this.data});
}

class WalletQpayCharge extends StatefulWidget {
  final QpayPayment data;

  static const routeName = "WalletQpayCharge";
  const WalletQpayCharge({super.key, required this.data});
                    ...
                    child: Column(
                      children: [
                        ...
                        GridView.builder(
                          ...
                          itemCount: widget.data.qpay!.urls!.length,
                          itemBuilder: (context, index) {
                            final data = widget.data.qpay!.urls![index];
