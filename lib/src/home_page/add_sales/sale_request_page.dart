...
class SaleRequestPageArguments {
  final String cardNumber;
  SaleRequestPageArguments({required this.cardNumber});
}

class SaleRequestPage extends StatefulWidget {
  final String cardNumber;

  static const routeName = "SaleRequestPage";
  const SaleRequestPage({super.key, required this.cardNumber});
