...
class _CreatePaymentState extends State<CreatePayment> {
  ...
  void initState() {
    widget.data.map((data) {
      print(
        "✅ Product INFOOOO: ${data.product}, ${data.quantity}, ${data.price}",
      );
      print('=====totalAmount=====');
    }).toList();
    print(widget.data);
    ...
    if (selectIndex != null) {
      try {
        ...
        if (selectIndex == 0) {
          ...
          qpayPayment = await ProductApi().checkPaymentMethod(widget.id, data);
          setState(() {
            isLoading = false;
          });
          saleSuccess(context);
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              border: showQpay == true
                                  ? Border(bottom: BorderSide(color: white50))
                                  : null,
                              // color: blue200,
                            ),
                            child: Row(
                              children: [
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    borderRadius: BorderRadius.circular(100),
                                    color: selectIndex == 1 ? orange : black100,
                                  ),
                                ),
                                SizedBox(width: 12),
                                Text(
