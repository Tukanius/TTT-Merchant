...
class ProfilePageToologch extends StatefulWidget {
  final Function(int) onChangePage;
  static const routeName = "ProfilePageToologch";
  const ProfilePageToologch({super.key, required this.onChangePage});

  @override
  State<ProfilePageToologch> createState() => _ProfilePageToologchState();
}

class _ProfilePageToologchState extends State<ProfilePageToologch>
          ...
          : Padding(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 16),
                  user.userType == "STORE_MAN" || user.userType == "TOOLOGCH"
                      ? SizedBox()
                      : Column(
                          children: [
                            GestureDetector(
