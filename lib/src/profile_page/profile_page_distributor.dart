...
class ProfilePageDistributor extends StatefulWidget {
  ...
  static const routeName = "ProfilePageDistributor";
  const ProfilePageDistributor({super.key, required this.onChangePage});

  @override
  State<ProfilePageDistributor> createState() => _ProfilePageDistributorState();
}

class _ProfilePageDistributorState extends State<ProfilePageDistributor>
