part of '../../models/sales_models/to_inventory.dart';

ToInventory _$ToInventoryFromJson(Map<String, dynamic> json) {
  return ToInventory(
...
Map<String, dynamic> _$ToInventoryToJson(ToInventory instance) {
