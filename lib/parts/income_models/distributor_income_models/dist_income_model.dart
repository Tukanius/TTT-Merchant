part of '../../../models/income_models/distributor_income_models/dist_income_model.dart';

DistIncomeModel _$DistIncomeModelFromJson(Map<String, dynamic> json) {
  return DistIncomeModel(
...
Map<String, dynamic> _$DistIncomeModelToJson(DistIncomeModel instance) {
