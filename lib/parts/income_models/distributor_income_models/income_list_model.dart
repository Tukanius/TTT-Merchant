part of '../../../models/income_models/distributor_income_models/income_list_model.dart';

IncomeListModel _$IncomeListModelFromJson(Map<String, dynamic> json) {
...
Map<String, dynamic> _$IncomeListModelToJson(IncomeListModel instance) {
