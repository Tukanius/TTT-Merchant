part of '../../../models/income_models/storeman_income_models/storeman_income_list.dart';

StoremanIncomeList _$StoremanIncomeListFromJson(Map<String, dynamic> json) {
  return StoremanIncomeList(
...
Map<String, dynamic> _$StoremanIncomeListToJson(StoremanIncomeList instance) {
