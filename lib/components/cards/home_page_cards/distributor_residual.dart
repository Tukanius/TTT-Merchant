...
class DistributorResidual extends StatefulWidget {
  final GeneralInit generalInit;
  const DistributorResidual({super.key, required this.generalInit});

  @override
  State<DistributorResidual> createState() => _DistributorResidualState();
}

class _DistributorResidualState extends State<DistributorResidual> {
  @override
